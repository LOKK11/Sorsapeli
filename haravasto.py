...
def lataa_kuvat(polku):
    ...
    kuvat["box"] = pyglet.resource.image("box.png")
    kuvat["barrel"] = pyglet.resource.image("barrel.png")
    kuvat["pum"] = pyglet.resource.image("pum.png")
...
def lataa_sorsa(polku):
    ...
    sorsa_reverse = pyglet.resource.image("sorsa_reverse.png")
    grafiikka["kuvat"]["sorsa"] = sorsa
    grafiikka["kuvat"]["ritsa"] = ritsa
    grafiikka["kuvat"]["sorsa_reverse"] = sorsa_reverse
...
def piirra_tekstia(teksti, x, y, vari=(0, 0, 0, 255), fontti="Microsoft Sans Serif", koko=32):
    """
